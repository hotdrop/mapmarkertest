...
import jp.hotdrop.mapmarkertest.databinding.CustomInfoWindowWithBackgroundBinding
import jp.hotdrop.mapmarkertest.model.MyClusterItem

class CustomInfoWindowArrowAdapter constructor(
    ...
    override fun getInfoWindow(p0: Marker?): View? {
        val binding = CustomInfoWindowWithBackgroundBinding.inflate(LayoutInflater.from(context))
